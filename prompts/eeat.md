...
For strengthening Experience, Expertise, Authoritativeness, and Trustworthiness signals. See the [E-E-A-T Checklist](../checklists/eeat.md) for the mechanical audit version.
...
marketing copy. Include one specific, checkable detail (a credential, a number of years,
a named project) rather than vague claims like "expert in the field."
```

**When to use:** Building out author pages, especially for YMYL (health/finance/legal) content.
...
include specific, first-hand detail (what I actually did, saw, tested, or measured).
```

**When to use:** Reviewing a draft before publishing, particularly for reviews, how-tos, and case studies.
...
**When to use:** A quick pre-publish trust audit, especially for YMYL content.
...
just describe what to go find or measure.
```

**When to use:** Tightening up claims before publishing, especially anything with a specific number or statistic.
