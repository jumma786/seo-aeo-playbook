...
For digital PR, linkable-asset ideation, and outreach — see [SEO Book, Chapter 18: Off-Page SEO & Link Building](../docs/books/complete/seo/chapter-18.md) and the [Link Building Checklist](../checklists/launch-checklist.md).
...
or link to. For each, note what data or resource I'd need to produce it.
```

**When to use:** Quarterly linkable-asset planning (the [Link Building Checklist](../checklists/launch-checklist.md) recommends at least one per quarter).
...
reason my asset is useful to their audience, and ask for nothing more than "would this
be useful to link to" — no generic flattery, no attachment of the whole asset inline.
```

**When to use:** Manual outreach after identifying a genuinely relevant target — always send from a real, non-automated context.
...
**When to use:** Working through unlinked-brand-mention monitoring — pairs with a mentions-tracking tool, not something this repo automates directly.
...
**When to use:** Periodic backlink profile health checks.
...
**When to use:** Only after manual link-removal attempts have failed — disavow is a last resort, not a first response (see the [Link Building Checklist](../checklists/launch-checklist.md)).
